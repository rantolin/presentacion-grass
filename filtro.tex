...
\begin{beamerboxesrounded}[shadow=true]{Definición: \emph{Borde}}
     \alt{\alert{NO} es un señor antipático $\Rightarrow$ \alert{NO} 
  ...
  \end{picture}
  \begin{picture}(0,100)
     \uncover{\put(200,-5){\includegraphics[height=30mm]{images/height_edge}}}
  \end{picture}
\begin{enumerate}
...
\begin{frame}
  \frametitle{Solapes}
    \begin{figure}[h!]
      \centering
      \only{\includegraphics[width=0.65\textwidth]{images/errores_aspect}}
      \only{\includegraphics[width=0.65\textwidth]{images/errores_aspect_mascara}}
      \only{\includegraphics[width=0.65\textwidth]{images/error_interpolacion_solapes}}
    \end{figure}
\end{frame}
%%==================================================================F
%\begin{frame}
